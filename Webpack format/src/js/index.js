...
let plans1 = document.getElementById("plans1");
let plans2 = document.getElementById("plans2");
let plansCards = document.getElementsByClassName("plans__cards");
